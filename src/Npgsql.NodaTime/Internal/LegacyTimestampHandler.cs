...
{
    public class LegacyTimestampHandlerFactory : NpgsqlTypeHandlerFactory<Instant>
    {
        public override NpgsqlTypeHandler<Instant> Create(PostgresType postgresType, NpgsqlConnector conn)
        {
            ...
            return new LegacyTimestampHandler(postgresType, conn.Settings.ConvertInfinityDateTime);
        }
    }
