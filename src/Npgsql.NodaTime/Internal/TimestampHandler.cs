...
{
    public class TimestampHandlerFactory : NpgsqlTypeHandlerFactory<LocalDateTime>
    {
        public override NpgsqlTypeHandler<LocalDateTime> Create(PostgresType postgresType, NpgsqlConnector conn)
        {
