...
namespace Npgsql.Tests
{
    public static class TestUtil
    {
        ...
        /// test database.
        /// </summary>
        public const string DefaultConnectionString = "Server=localhost;Username=npgsql_tests;Password=npgsql_tests;Database=npgsql_tests;Timeout=0;Command Timeout=0;Port=5433";
